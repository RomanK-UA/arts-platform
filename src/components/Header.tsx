...
const Header = () => {
    return (
        <header className='col-span-full md:col-start-2 md:col-end-6 flex justify-center p-4 h-16 mx-auto text-2xl w-full md:text-3xl backdrop-blur-md sticky top-0 z-50 '>
